...
public class ROS_IDLParser extends Parser {
	...
	public ROS_IDLParser(TokenStream input) {
		super(input);
		_interp = new ParserATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}

	public static class SpecificationContext extends ParserRuleContext {
		public List<TerminalNode> DEFINITION() { return getTokens(ROS_IDLParser.DEFINITION); }
		public TerminalNode DEFINITION(int i) {
			return getToken(ROS_IDLParser.DEFINITION, i);
		}
